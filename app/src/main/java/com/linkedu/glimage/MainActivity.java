...
public class MainActivity extends AppCompatActivity {
    public static final String LOG_TAG = "glimage";
    ...
    public static class ClassDescription {
        ...
        ClassDescription(String _name, String _title) {
            activityName = _name;
            title = _title;
        }
    }

    private static final ClassDescription mDemos[] = new ClassDescription[] {
            new ClassDescription("BasicImageActivity", "Basic Image Filter Demo"),
            new ClassDescription("ImageActivity", "Advanced Image Filter Demo"),
            new ClassDescription("CameraDemoActivity", "Camera Filter Demo"),
            new ClassDescription("SimplePlayerDemoActivity", "Simple Player Demo"),
            new ClassDescription("VideoPlayerDemoActivity", "Video Player Demo"),
            new ClassDescription("FaceTrackingDemoActivity", "Face Tracking Demo"),
            new ClassDescription("TestCaseActivity", "Test Cases")
    };

    public class DemoButton extends Button implements View.OnClickListener{
        private ClassDescription mDemo;

        public void setDemo(ClassDescription demo) {
            mDemo = demo;
            setAllCaps(false);
            setText(mDemo.title);
        ...
        public void onClick(final View v) {
            ...
            Class cls;
            try {
                cls = Class.forName("com.linkedu.glimage." + mDemo.activityName);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (ClassDescription demo : mDemos) {
