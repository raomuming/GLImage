...
import com.linkedu.glimage.view.ImageGLSurfaceView;
import com.linkedu.glimage.nativeport.ImageHandler;
import com.linkedu.glimage.utils.MsgUtil;
import com.linkedu.glimage.utils.ImageUtil;

public class BasicImageActivity extends AppCompatActivity {
    protected static final String BASIC_FILTER_CONFIG = "@adjust brightness 0 @adjust contrast 1 @adjust saturation 1 @adjust sharp 0";
    ...
    AdjustConfig mAdjustConfigs[] = {
            new AdjustConfig(0, -1.0f, 0.0f, 1.0f),
            new AdjustConfig(1, 0.1f, 1.0f, 3.0f),
            new AdjustConfig(2, 0.0f, 1.0f, 3.0f),
            new AdjustConfig(3, -1.0f, 0.0f, 10.0f)
    };
    ...
    public static class MyButton extends AppCompatButton implements View.OnClickListener {
        ...
        BasicImageActivity mImageActivity;

        public MyButton(BasicImageActivity context, AdjustConfig config) {
            super(context);
            mImageActivity = context;
            mConfig = config;
        ...
        public void onClick(View v) {
            mImageActivity.setActiveConfig(mConfig);
        }
    }
        ...
        mImageView.getResultBitmap(new ImageGLSurfaceView.QueryResultBitmapCallback(){
            ...
            public void get(Bitmap bmp) {
                ...
                mImageView.post(new Runnable(){
                    @Override
                    public void run() {
                        MsgUtil.toastMsg(BasicImageActivity.this, "Image saved: " + s);
                    }
                });
            }
        });
    ...
    public void resetBtnClicked(View view) {
        mImageView.queueEvent(new Runnable(){
            public void run() {
                ImageHandler handler = mImageView.getImageHandler();
    ...
    public void onDestroy() {
        Log.i("TAG", "Filter Demo onDestroy...");
        super.onDestroy();
    }

    @Override
    public void onPause() {
        Log.i("TAG", "Filter Demo onPause...");
        super.onPause();
        mImageView.release();
        mImageView.onPause();
    }
    ...
    public void onResume() {
        Log.i("TAG", "Filter Demo onResume...");
        super.onResume();
        mImageView.onResume();
    }
}
